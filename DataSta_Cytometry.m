...
for fd=Folder
    ...
    BgList=extractBgList(ImSet,PMMask,ArtifactMask);
...
save([FilePath,'\DataSta_output_',num2str(Folder(1)),'to',num2str(Folder(end)),'.mat'],'Folder','Color','PixelLength','trimXY1','trimXY2','shiftedPearsonMatrix_2p','shiftedPearsonMatrix_3p','PMSize','NucleusSize','FilePath');
